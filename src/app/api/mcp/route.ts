...
/**
 * The MCP server for Julius.
 *
 * The division of labour: the agent reads the photograph — it is the thing with
 * eyes — and this server is the typed, validated way to write what it read.
 ...
 *
 * Nothing in this file can reach the database on its own. Every call passes the
